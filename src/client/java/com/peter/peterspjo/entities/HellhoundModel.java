...
public class HellhoundModel extends EntityModel<Hellhound> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData head = modelPartData.addChild("head", ModelPartBuilder.create().uv(0, 82).cuboid(-6.0F, -31.0F,
				-23.0F, 12.0F, 10.0F, 10.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 24.0F, 0.0F));
	...
	@Override
	public void setAngles(Hellhound entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
			float headPitch) {
	}
